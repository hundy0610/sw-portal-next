      ...
      <div className="flex-none bg-white border-b px-5 py-3 flex flex-wrap items-center gap-3 shadow-sm">
        ...
        <div className="ml-auto flex items-center gap-2 flex-wrap">
          ...
          {isSuper && <button
            ...
            className="p-2 rounded-lg border border-gray-200 text-gray-400 hover:border-slate-400 hover:text-slate-700 transition-all flex items-center justify-center"
            title="건물/층/그룹 관리">
