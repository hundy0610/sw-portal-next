...
function SwStatusCard({
  name, total, using, stock, waiting, expired,
}: {
...
export default function LicensePanel() {
  ...
  const summary = useMemo(() => {
    ...
    const expiring = records.filter((r) => {
      const d = daysLeft(r.licenseExpiryDate);
                ...
                {filtered.length === 0 ? (
                  ...
                  return (
                    ...
                    >
                      <td className="px-4 py-3 whitespace-nowrap">
                        <div className="flex items-center gap-1.5">
                          ...
                          <div>
                            ...
                            {r.softwareDetail && (
                              <div className="text-xs text-gray-400">{r.softwareDetail}</div>
                            )}
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3">
                        <StatusBadge status={r.usageStatus} />
                      </td>
