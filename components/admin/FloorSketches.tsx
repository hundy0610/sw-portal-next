...
function Seat({ x, y, w=22, h=12, orient, seat, ctx }: {
  ...
  const deskStroke = dimmed ? "#D1D5DB" : "#18181B";
  ...
  return (
    <g style={{ cursor:"pointer" }} onClick={() => !dimmed && ctx.onSelect(seat.id)}>
      <rect x={x+chairPad} y={chairY} width={w-chairPad*2} height={chairH} rx={2.5}
        fill={dimmed?"#F3F4F6":"#E8EAED"} stroke={dimmed?"#E4E4E7":"#A1A1AA"} strokeWidth={0.7}/>
...
const HATCH = (
  <defs>
    <pattern id="hatch" width="5" height="5" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
      <line x1="0" y1="0" x2="0" y2="5" stroke="#71717A" strokeWidth="0.6"/>
    </pattern>
...
function BW_Core({y0=20,y1=548}:{y0?:number;y1?:number}) {
  ...
  const mid=y0+h/2;
  return (<g>
    <rect x={cx} y={y0} width={cw} height={h} fill="#E4E4E7" stroke="#52525B" strokeWidth={1.5}/>
    {/* PS 상단 좌우 */}
    <rect x={cx} y={y0} width={32} height={26} fill="#F4F4F5" stroke="#A1A1AA" strokeWidth={0.8}/>
    <text x={cx+16} y={y0+16} fontSize={6} textAnchor="middle" fill="#52525B">P.S.</text>
    <rect x={cx+cw-32} y={y0} width={32} height={26} fill="#F4F4F5" stroke="#A1A1AA" strokeWidth={0.8}/>
    <text x={cx+cw-16} y={y0+16} fontSize={6} textAnchor="middle" fill="#52525B">P.S.</text>
    {/* UP 계단 */}
    <rect x={cx+34} y={y0} width={114} height={82} fill="url(#hatchLight)" stroke="#52525B" strokeWidth={1.2}/>
    {Array.from({length:7},(_,i)=><line key={i} x1={cx+36} y1={y0+10+i*11} x2={cx+146} y2={y0+10+i*11} stroke="#52525B" strokeWidth={0.6}/>)}
    <text x={cx+40} y={y0+12} fontSize={7} fill="#52525B" fontWeight={700}>UP</text>
    <text x={cx+132} y={y0+80} fontSize={7} fill="#52525B" fontWeight={700}>DN</text>
    {/* EPS 상단 좌우 */}
    <rect x={cx} y={y0+28} width={32} height={48} fill="url(#hatch)" stroke="#52525B" strokeWidth={0.9}/>
    <text x={cx+16} y={y0+55} fontSize={6.5} textAnchor="middle" fill="#18181B" fontWeight={700}>EPS</text>
    <rect x={cx+cw-32} y={y0+28} width={32} height={48} fill="url(#hatch)" stroke="#52525B" strokeWidth={0.9}/>
    <text x={cx+cw-16} y={y0+55} fontSize={6.5} textAnchor="middle" fill="#18181B" fontWeight={700}>EPS</text>
    {/* DS 엘리베이터 (X패턴) */}
    <rect x={cx+34} y={y0+86} width={114} height={100} fill="#D1D5DB" stroke="#52525B" strokeWidth={1.2}/>
    <line x1={cx+34} y1={y0+86} x2={cx+148} y2={y0+186} stroke="#A1A1AA" strokeWidth={1}/>
    <line x1={cx+148} y1={y0+86} x2={cx+34} y2={y0+186} stroke="#A1A1AA" strokeWidth={1}/>
    <text x={cx+91} y={y0+139} fontSize={8} textAnchor="middle" fill="#52525B" fontWeight={700}>D.S.</text>
    {/* SOFA 구역 */}
    <rect x={cx+6} y={y0+190} width={cw-12} height={52} fill="#FAFAFA" stroke="#52525B" strokeWidth={0.8}/>
    <text x={cx+91} y={y0+214} fontSize={7.5} textAnchor="middle" fill="#52525B" fontWeight={700}>SOFA</text>
    ...
    {/* EPS 하단 좌우 */}
    <rect x={cx} y={y0+246} width={32} height={48} fill="url(#hatch)" stroke="#52525B" strokeWidth={0.9}/>
    <text x={cx+16} y={y0+273} fontSize={6.5} textAnchor="middle" fill="#18181B" fontWeight={700}>EPS</text>
    <rect x={cx+cw-32} y={y0+246} width={32} height={48} fill="url(#hatch)" stroke="#52525B" strokeWidth={0.9}/>
    <text x={cx+cw-16} y={y0+273} fontSize={6.5} textAnchor="middle" fill="#18181B" fontWeight={700}>EPS</text>
    {/* DN 계단 */}
    <rect x={cx+34} y={y0+298} width={114} height={h-324} fill="url(#hatchLight)" stroke="#52525B" strokeWidth={1.2}/>
    {Array.from({length:6},(_,i)=><line key={i} x1={cx+36} y1={y0+308+i*13} x2={cx+146} y2={y0+308+i*13} stroke="#52525B" strokeWidth={0.6}/>)}
    <text x={cx+40} y={y0+310} fontSize={7} fill="#52525B" fontWeight={700}>DN</text>
    {/* PS 하단 좌우 */}
    <rect x={cx} y={y1-26} width={32} height={26} fill="#F4F4F5" stroke="#A1A1AA" strokeWidth={0.8}/>
    <text x={cx+16} y={y1-10} fontSize={6} textAnchor="middle" fill="#52525B">P.S.</text>
    <rect x={cx+cw-32} y={y1-26} width={32} height={26} fill="#F4F4F5" stroke="#A1A1AA" strokeWidth={0.8}/>
    <text x={cx+cw-16} y={y1-10} fontSize={6} textAnchor="middle" fill="#52525B">P.S.</text>
  </g>);
}
...
export function BW_2F_Sketch(ctx: SketchCtx) {
  ...
  return (
    <svg viewBox="0 0 820 540" style={{width:"100%",maxWidth:960,height:"auto",display:"block"}}>
      {HATCH}
      <rect x={12} y={20} width={796} height={510} fill="#FAFAFA" stroke="#18181B" strokeWidth={2}/>
      {Array.from({length:24},(_,i)=><line key={`t${i}`} x1={30+i*32} y1={20} x2={30+i*32} y2={28} stroke="#818CF8" strokeWidth={2} opacity={0.5}/>)}
      {Array.from({length:24},(_,i)=><line key={`b${i}`} x1={30+i*32} y1={530} x2={30+i*32} y2={522} stroke="#818CF8" strokeWidth={2} opacity={0.5}/>)}
      {/* 스마트오피스 프레임 */}
      <rect x={14} y={28} width={340} height={492} rx={4} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1.2} strokeDasharray="6,3"/>
      ...
      {/* ELEV HALL */}
      <rect x={474} y={28} width={88} height={88} fill="url(#hatchLight)" stroke="#52525B" strokeWidth={1.2}/>
      {Array.from({length:7},(_,i)=><line key={i} x1={474} y1={38+i*11} x2={562} y2={38+i*11} stroke="#52525B" strokeWidth={0.6}/>)}
      <text x={480} y={40} fontSize={7} fill="#52525B" fontWeight={700}>UP</text>
      <rect x={474} y={124} width={40} height={52} fill="#E4E4E7" stroke="#52525B" strokeWidth={1.2}/>
      <line x1={474} y1={124} x2={514} y2={176} stroke="#52525B" strokeWidth={0.5}/>
      <line x1={514} y1={124} x2={474} y2={176} stroke="#52525B" strokeWidth={0.5}/>
      <text x={494} y={152} fontSize={7} fill="#52525B" textAnchor="middle">EV</text>
      <rect x={522} y={124} width={40} height={52} fill="#E4E4E7" stroke="#52525B" strokeWidth={1.2}/>
      <line x1={522} y1={124} x2={562} y2={176} stroke="#52525B" strokeWidth={0.5}/>
      <line x1={562} y1={124} x2={522} y2={176} stroke="#52525B" strokeWidth={0.5}/>
      <text x={542} y={152} fontSize={7} fill="#52525B" textAnchor="middle">EV</text>
      <rect x={474} y={184} width={88} height={95} fill="#FAFAFA" stroke="#52525B" strokeWidth={1.2}/>
      <text x={518} y={228} fontSize={8} fontWeight={700} fill="#52525B" textAnchor="middle">ELEV HALL</text>
      ...
      <rect x={474} y={287} width={40} height={52} fill="#E4E4E7" stroke="#52525B" strokeWidth={1.2}/>
      <line x1={474} y1={287} x2={514} y2={339} stroke="#52525B" strokeWidth={0.5}/>
      <line x1={514} y1={287} x2={474} y2={339} stroke="#52525B" strokeWidth={0.5}/>
      <rect x={522} y={287} width={40} height={52} fill="#E4E4E7" stroke="#52525B" strokeWidth={1.2}/>
      <line x1={522} y1={287} x2={562} y2={339} stroke="#52525B" strokeWidth={0.5}/>
      <line x1={562} y1={287} x2={522} y2={339} stroke="#52525B" strokeWidth={0.5}/>
      <rect x={474} y={348} width={88} height={95} fill="url(#hatchLight)" stroke="#52525B" strokeWidth={1.2}/>
      {Array.from({length:7},(_,i)=><line key={i} x1={474} y1={358+i*11} x2={562} y2={358+i*11} stroke="#52525B" strokeWidth={0.6}/>)}
      <text x={548} y={440} fontSize={7} fill="#52525B">DN</text>
      <rect x={474} y={450} width={88} height={70} fill="#FAFAFA" stroke="#52525B" strokeWidth={1}/>
      <text x={518} y={482} fontSize={7} fill="#52525B" textAnchor="middle">화장실(남)</text>
      {/* 우측: 화장실·EPS·라운지·창고 */}
      ...
      <rect x={566} y={124} width={35} height={52} fill="url(#hatch)" stroke="#52525B" strokeWidth={1}/>
      <text x={584} y={153} fontSize={7} textAnchor="middle" fill="#18181B" fontWeight={700}>EPS</text>
      ...
      <rect x={566} y={312} width={100} height={67} fill="#F4F4F5" stroke="#52525B" strokeWidth={1.2}/>
      <text x={616} y={348} fontSize={8} textAnchor="middle" fill="#52525B" fontWeight={700}>창고 2평</text>
      <rect x={566} y={387} width={35} height={52} fill="url(#hatch)" stroke="#52525B" strokeWidth={1}/>
      <text x={584} y={416} fontSize={7} textAnchor="middle" fill="#18181B" fontWeight={700}>EPS</text>
      <rect x={566} y={447} width={70} height={73} fill="#EEF2FF" stroke="#4338CA" strokeWidth={1}/>
      <text x={601} y={482} fontSize={7.5} textAnchor="middle" fill="#4338CA" fontWeight={700}>화장실(남)</text>
      {/* VOID */}
      <rect x={670} y={28} width={136} height={492} fill="url(#hatchLight)" stroke="#A1A1AA" strokeWidth={1}/>
      ...
      <text x={738} y={274} fontSize={13} textAnchor="middle" fill="#52525B" fontWeight={700}>VOID</text>
      <text x={20} y={16} fontSize={9} fontWeight={800} fill="#18181B">← 서편</text>
      <text x={800} y={16} fontSize={9} fontWeight={800} fill="#18181B" textAnchor="end">동편 →</text>
    </svg>
  );
}
...
export function BW_3F_Sketch(ctx: SketchCtx) {
  ...
  return (
    <svg viewBox="0 0 820 560" style={{width:"100%",maxWidth:960,height:"auto",display:"block"}}>
      {HATCH}
      <rect x={12} y={20} width={796} height={528} fill="#FAFAFA" stroke="#18181B" strokeWidth={2}/>
      {Array.from({length:24},(_,i)=><line key={`t${i}`} x1={30+i*32} y1={20} x2={30+i*32} y2={28} stroke="#818CF8" strokeWidth={2} opacity={0.5}/>)}
      {Array.from({length:24},(_,i)=><line key={`b${i}`} x1={30+i*32} y1={548} x2={30+i*32} y2={540} stroke="#818CF8" strokeWidth={2} opacity={0.5}/>)}
      {/* 서편 */}
      <rect x={14} y={20} width={290} height={528} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
      ...
      {/* 동편 */}
      <rect x={494} y={20} width={314} height={528} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
      ...
      <rect x={502} y={28} width={28} height={18} rx={2} fill="#18181B" stroke="#52525B" strokeWidth={0.8}/>
      <text x={516} y={40} fontSize={6} textAnchor="middle" fill="white">TV</text>
      <rect x={536} y={28} width={28} height={18} rx={2} fill="#18181B" stroke="#52525B" strokeWidth={0.8}/>
...
export function BW_4F_Sketch(ctx: SketchCtx) {
  ...
  return (
    <svg viewBox="0 0 820 580" style={{width:"100%",maxWidth:960,height:"auto",display:"block"}}>
      {HATCH}
      <rect x={12} y={20} width={796} height={548} fill="#FAFAFA" stroke="#18181B" strokeWidth={2}/>
      {Array.from({length:24},(_,i)=><line key={`t${i}`} x1={30+i*32} y1={20} x2={30+i*32} y2={28} stroke="#818CF8" strokeWidth={2} opacity={0.5}/>)}
      {Array.from({length:24},(_,i)=><line key={`b${i}`} x1={30+i*32} y1={568} x2={30+i*32} y2={560} stroke="#818CF8" strokeWidth={2} opacity={0.5}/>)}
      {/* 서편 */}
      <rect x={14} y={20} width={290} height={548} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
      <text x={22} y={38} fontSize={8.5} fontWeight={800} fill="#1E3A8A">서편 — {zW.seats.length}석</text>
      {/* 화상회의실 상단 */}
      ...
      {/* 동편 */}
      <rect x={494} y={20} width={314} height={548} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
      <text x={502} y={38} fontSize={8.5} fontWeight={800} fill="#1E3A8A">동편 — {zE.seats.length}석</text>
      {/* 동편 데스크 7×7=49석 */}
...
export function BW_7F_Sketch(ctx: SketchCtx) {
  ...
  return (
    <svg viewBox="0 0 820 560" style={{width:"100%",maxWidth:960,height:"auto",display:"block"}}>
      ...
      <rect x={14} y={20} width={290} height={528} rx={3} fill="#FAFAFA" stroke="#A1A1AA" strokeWidth={1}/>
      {/* 미팅룸 상단 4개 */}
      ...
      {/* 스마트오피스 19석 */}
      <rect x={14} y={258} width={290} height={130} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="4,2"/>
...
export function BW_8F_Sketch(ctx: SketchCtx) {
  ...
  return (
    <svg viewBox="0 0 820 500" style={{width:"100%",maxWidth:960,height:"auto",display:"block"}}>
      {HATCH}
      <rect x={12} y={20} width={796} height={468} fill="#FAFAFA" stroke="#18181B" strokeWidth={2}/>
      {Array.from({length:24},(_,i)=><line key={`t${i}`} x1={30+i*32} y1={20} x2={30+i*32} y2={28} stroke="#818CF8" strokeWidth={2} opacity={0.5}/>)}
      {Array.from({length:24},(_,i)=><line key={`b${i}`} x1={30+i*32} y1={488} x2={30+i*32} y2={480} stroke="#818CF8" strokeWidth={2} opacity={0.5}/>)}
      {/* 서편: 스마트오피스 28석 */}
      <rect x={14} y={20} width={290} height={250} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
      ...
      {/* 동편: 미팅룸 6개 (2열×3행) */}
      <rect x={494} y={20} width={314} height={468} rx={3} fill="#FAFAFA" stroke="#A1A1AA" strokeWidth={1}/>
      <text x={502} y={36} fontSize={8.5} fontWeight={800} fill="#52525B">미팅룸</text>
      ...
      <text x={20} y={16} fontSize={9} fontWeight={800} fill="#18181B">← 서편</text>
      <text x={800} y={16} fontSize={9} fontWeight={800} fill="#18181B" textAnchor="end">동편 (미팅룸) →</text>
    </svg>
  );
}
...
export function BW_9F_Sketch(ctx: SketchCtx) {
  ...
  return (
    <svg viewBox="0 0 880 600" style={{width:"100%",maxWidth:1050,height:"auto",display:"block"}}>
      {HATCH}
      <rect x={12} y={20} width={856} height={568} fill="#FAFAFA" stroke="#18181B" strokeWidth={2}/>
      {Array.from({length:26},(_,i)=><line key={`t${i}`} x1={30+i*32} y1={20} x2={30+i*32} y2={28} stroke="#818CF8" strokeWidth={2} opacity={0.5}/>)}
      {Array.from({length:26},(_,i)=><line key={`b${i}`} x1={30+i*32} y1={588} x2={30+i*32} y2={580} stroke="#818CF8" strokeWidth={2} opacity={0.5}/>)}
      {/* 서편: 스튜디오 37석 */}
      <rect x={14} y={20} width={290} height={568} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
      ...
      {/* 동편: 홀 85석 */}
      <rect x={494} y={20} width={374} height={568} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
      ...
      <text x={20} y={16} fontSize={9} fontWeight={800} fill="#18181B">← 서편 (스튜디오)</text>
      <text x={860} y={16} fontSize={9} fontWeight={800} fill="#18181B" textAnchor="end">동편 (홀) →</text>
    </svg>
  );
}
...
function NS_RightCore() {
  return (<g>
    {/* 계단 블록 */}
    <rect x={608} y={108} width={130} height={100} fill="url(#hatchLight)" stroke="#52525B" strokeWidth={1.2}/>
    {Array.from({length:7},(_,i)=><line key={i} x1={610} y1={118+i*13} x2={736} y2={118+i*13} stroke="#52525B" strokeWidth={0.6}/>)}
    <text x={614} y={120} fontSize={7} fill="#52525B" fontWeight={700}>UP</text>
    <text x={722} y={206} fontSize={7} fill="#52525B" fontWeight={700}>DN</text>
    {/* HALL */}
    <rect x={608} y={212} width={110} height={68} fill="#FAFAFA" stroke="#52525B" strokeWidth={1}/>
    <text x={663} y={248} fontSize={8} textAnchor="middle" fill="#52525B" fontWeight={700}>HALL</text>
    {/* EPS */}
    <rect x={608} y={284} width={48} height={46} fill="url(#hatch)" stroke="#52525B" strokeWidth={0.9}/>
    <text x={632} y={310} fontSize={7} textAnchor="middle" fill="#18181B" fontWeight={700}>EPS</text>
  </g>);
}
    ...
    <svg viewBox="0 0 960 700" style={{width:"100%",maxWidth:1100,height:"auto",display:"block"}}>
      ...
      <g transform="rotate(-19, 60, 290)">
        <rect x={68} y={296} width={548} height={106} rx={3}
          fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
      ...
      <rect x={722} y={160} width={80} height={48} fill="#EEF2FF" stroke="#4338CA" strokeWidth={1}/>
      <text x={762} y={185} fontSize={7} textAnchor="middle" fill="#4338CA" fontWeight={700}>화장실(남)</text>
      <rect x={808} y={108} width={120} height={100} fill="#E4E4E7" stroke="#52525B" strokeWidth={1}/>
      <line x1={808} y1={108} x2={928} y2={208} stroke="#A1A1AA" strokeWidth={0.8}/>
      <line x1={928} y1={108} x2={808} y2={208} stroke="#A1A1AA" strokeWidth={0.8}/>
      <text x={868} y={160} fontSize={7} textAnchor="middle" fill="#52525B">EV홀</text>
      {/* 미팅룸들 */}
...
export function SB_3F_Sketch(ctx: SketchCtx) {
  ...
  return (
    <svg viewBox="0 0 960 680" style={{width:"100%",maxWidth:1100,height:"auto",display:"block"}}>
      ...
      <SB_Shell/>
      {/* 상단 좌측: 계단/EV 블록 */}
      <rect x={80} y={90} width={130} height={100} fill="url(#hatchLight)" stroke="#52525B" strokeWidth={1.2}/>
      {Array.from({length:6},(_,i)=><line key={i} x1={82} y1={100+i*14} x2={208} y2={100+i*14} stroke="#52525B" strokeWidth={0.6}/>)}
      <text x={86} y={102} fontSize={7} fill="#52525B" fontWeight={700}>DN</text>
      <text x={194} y={188} fontSize={7} fill="#52525B" fontWeight={700}>UP</text>
      {/* EPS */}
      <rect x={80} y={194} width={48} height={42} fill="url(#hatch)" stroke="#52525B" strokeWidth={0.9}/>
      <text x={104} y={218} fontSize={7} textAnchor="middle" fill="#18181B" fontWeight={700}>EPS</text>
      {/* LOCKER */}
      <rect x={132} y={194} width={78} height={42} fill="#F4F4F5" stroke="#A1A1AA" strokeWidth={0.8}/>
      <text x={171} y={218} fontSize={7} textAnchor="middle" fill="#52525B" fontWeight={700}>LOCKER</text>
      {/* 상단 우측: 화장실 + 미팅룸 */}
      ...
      <rect x={534} y={90} width={60} height={90} fill="#EEF2FF" stroke="#4338CA" strokeWidth={1}/>
      <text x={564} y={135} fontSize={7} textAnchor="middle" fill="#4338CA" fontWeight={700}>화장실(F)</text>
      ...
      {/* 유리벽 구분선 */}
      <line x1={210} y1={244} x2={880} y2={244} stroke="#818CF8" strokeWidth={1.5} strokeDasharray="6,3"/>
      <text x={540} y={240} fontSize={7} fill="#6366F1" textAnchor="middle">— 유리벽 —</text>
      {/* Smart Office 1: 15석 (정적 표시) */}
      <rect x={80} y={258} width={260} height={280} rx={3} fill="#F4F4F5" stroke="#A1A1AA" strokeWidth={1} strokeDasharray="4,2"/>
      <text x={210} y={276} fontSize={9} textAnchor="middle" fill="#52525B" fontWeight={700}>Smart Office 1</text>
      <text x={210} y={290} fontSize={8} textAnchor="middle" fill="#A1A1AA">84.4㎡ · 25.5평 · 15석</text>
      {/* 정적 책상 그리드 (15석 표시용) */}
      {Array.from({length:3},(_,row)=>Array.from({length:5},(_,col)=>(
        <rect key={`so1-${row}-${col}`}
          x={96+col*46} y={308+row*66} width={34} height={14} rx={2}
          fill="#E4E4E7" stroke="#A1A1AA" strokeWidth={0.6}/>
      )))}
      {/* Smart Office 2: zone M (40석 인터랙티브) */}
      <rect x={344} y={258} width={532} height={300} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
      <text x={610} y={276} fontSize={9} textAnchor="middle" fill="#1E3A8A" fontWeight={700}>Smart Office 2 — {zone.seats.length}석</text>
      <text x={610} y={290} fontSize={7.5} textAnchor="middle" fill="#6366F1">142.8㎡ · 43.2평</text>
      ...
      <rect x={608} y={562} width={100} height={48} fill="#F4F4F5" stroke="#A1A1AA" strokeWidth={1}/>
      <text x={658} y={588} fontSize={7.5} textAnchor="middle" fill="#52525B" fontWeight={700}>서버실</text>
...
export function SB_4F_Sketch(ctx: SketchCtx) {
  ...
  return (
    <svg viewBox="0 0 960 680" style={{width:"100%",maxWidth:1100,height:"auto",display:"block"}}>
      ...
      <rect x={80} y={90} width={130} height={100} fill="url(#hatchLight)" stroke="#52525B" strokeWidth={1.2}/>
      {Array.from({length:6},(_,i)=><line key={i} x1={82} y1={100+i*14} x2={208} y2={100+i*14} stroke="#52525B" strokeWidth={0.6}/>)}
      <text x={86} y={102} fontSize={7} fill="#52525B" fontWeight={700}>DN/UP</text>
      {/* 화장실 + 샤워 */}
      ...
      <rect x={289} y={90} width={70} height={90} fill="#EEF2FF" stroke="#4338CA" strokeWidth={1}/>
      <text x={324} y={135} fontSize={7} textAnchor="middle" fill="#4338CA" fontWeight={700}>샤워실</text>
      {/* LOCKER */}
      <rect x={363} y={90} width={80} height={90} fill="#F4F4F5" stroke="#A1A1AA" strokeWidth={1}/>
      <text x={403} y={135} fontSize={7} textAnchor="middle" fill="#52525B" fontWeight={700}>LOCKER</text>
      {/* Focus Offices 상단 5개 */}
      {["Focus 1","Focus 2","Focus 3","Focus 4","Focus 5"].map((n,i)=>(
        <MeetingBox key={n} x={447+i*87} y={90} w={83} h={90} name={n} sub="5.0m²"/>
      ))}
      {/* 유리벽 */}
      <line x1={210} y1={192} x2={880} y2={192} stroke="#818CF8" strokeWidth={1.5} strokeDasharray="6,3"/>
      {/* CASUAL WORK SPACE */}
      ...
      {[-40,-20,0,20,40].map(d=><circle key={d} cx={430+d} cy={248} r={9} fill="#F3F4F6" stroke="#A1A1AA" strokeWidth={0.6}/>)}
      {[-40,-20,0,20,40].map(d=><circle key={d+"b"} cx={430+d} cy={342} r={9} fill="#F3F4F6" stroke="#A1A1AA" strokeWidth={0.6}/>)}
      {/* OPEN OFFICE (zone M) */}
      <rect x={518} y={206} width={358} height={340} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
...
export function SB_5F_Sketch(ctx: SketchCtx) {
  ...
  return (
    <svg viewBox="0 0 960 680" style={{width:"100%",maxWidth:1100,height:"auto",display:"block"}}>
      ...
      <rect x={329} y={90} width={80} height={90} fill="#F4F4F5" stroke="#A1A1AA" strokeWidth={1}/>
      <text x={369} y={138} fontSize={7.5} textAnchor="middle" fill="#52525B" fontWeight={700}>카운터</text>
      ...
      <rect x={641} y={138} width={80} height={42} fill="#EEF2FF" stroke="#4338CA" strokeWidth={1}/>
      <text x={681} y={162} fontSize={7} textAnchor="middle" fill="#4338CA" fontWeight={700}>화장실(남)</text>
      <rect x={725} y={90} width={151} height={90} fill="#E4E4E7" stroke="#52525B" strokeWidth={1}/>
      <line x1={725} y1={90} x2={876} y2={180} stroke="#A1A1AA" strokeWidth={0.8}/>
      <line x1={876} y1={90} x2={725} y2={180} stroke="#A1A1AA" strokeWidth={0.8}/>
      <text x={800} y={140} fontSize={7} textAnchor="middle" fill="#52525B">EV홀</text>
      {/* 유리벽 */}
      <line x1={210} y1={192} x2={880} y2={192} stroke="#818CF8" strokeWidth={1.5} strokeDasharray="6,3"/>
      {/* 라운지 */}
      ...
      {/* OPEN OFFICE (zone M) */}
      <rect x={528} y={206} width={348} height={350} rx={3} fill="#EEF2FF" stroke="#A5B4FC" strokeWidth={1} strokeDasharray="5,2"/>
