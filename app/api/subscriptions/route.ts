...
const DB_ID = process.env.NOTION_DB_SUBSCRIPTIONS ?? "2b767f4bfdac81e7925cf194e3094253";
...
export async function GET() {
    try {
      ...
      const items = response.results.map((page: any) => {
              ...
              const getDate = (p: any): string | null => p?.date?.start ?? null;
                                               ...
                                               return {
                                                         ...
                                                         status: getSelect(props["상태"]) ?? "구독 중",
      ...
      return NextResponse.json(items);
          ...
          console.error(import { NextResponse } from "next/server";
      import { Client } from "@notionhq/client";
